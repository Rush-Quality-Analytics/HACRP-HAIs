...
#for i in sorted(main_df['Measure ID'].unique()): print(i)
#sys.exit()
...
measures = ['MRSA Predicted Cases', 'MRSA patient days', 
            'MRSA', 'MRSA upper CL', 
...
df.to_pickle(mydir + "1_preprocess_CareCompare_data/preprocessed_HAI_data/MRSA_Data.pkl")