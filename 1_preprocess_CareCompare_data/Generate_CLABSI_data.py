...
measures = ['CLABSI', 'CLABSI Predicted Cases', 'CLABSI Number of Device Days', 'CLABSI upper CL', 
            'CLABSI Number of Procedures', 'CLABSI Observed Cases', 'CLABSI lower CL']
...
main_df = main_df[~main_df['Measure ID'].isin(['HAI_1a_CI_UPPER', 'HAI_1a_DOPC_DAYS', 
                                               'HAI_1a_CI_LOWER', 'HAI_1a_ELIGCASES', 
                                               'HAI_1a_NUMERATOR'])]
'''
...
df.to_pickle(mydir + "1_preprocess_CareCompare_data/preprocessed_HAI_data/CLABSI_Data.pkl")
